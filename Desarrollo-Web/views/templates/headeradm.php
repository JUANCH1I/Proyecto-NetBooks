    ...
    <div class="container" bis_skin_checked="1">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start" bis_skin_checked="1">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="abm/abmPersona/abm.php" class="nav-link px-2 text-white">Abm usuarios</a></li>
          <li><a href="abm/abmPreguntas/abm.php" class="nav-link px-2 text-white">Abm preguntas</a></li>
